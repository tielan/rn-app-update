...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private void startDownload(UpdateAppBean updateApp, final DownloadCallback callback) {
        ...
        updateApp.getHttpManager().download(apkUrl, updateApp.getApiKey(), target, appName, new FileDownloadCallBack(callback));
    }
    ...
    public class DownloadBinder extends Binder {
         ...
         * @param callback  下载回调
         */
        public void start(final UpdateAppBean updateApp, final DownloadCallback callback) {
            //下载
