package com.chinacreator.updateapp.module.update;
 ...
 * 版本更新管理器
 */
public class DUpdateAppManager {
    ...
    private static final String TAG = DUpdateAppManager.class.getSimpleName();
    ...
    private DUpdateAppManager(Builder builder) {
     ...
     *
     */
    public void checkNewApp(UpdateAppBean bean) {
    ...
    public static class Builder {
         ...
         * @return 生成app管理器
         */
        public DUpdateAppManager build() {
            //校验
            ...
            return new DUpdateAppManager(this);
        }
