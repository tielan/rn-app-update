...
import com.chinacreator.zw.update_app.utils.ColorUtil;
import com.chinacreator.zw.update_app.utils.DrawableUtil;
...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private int mDefaultPicResId = R.mipmap.update_app_top_bg;
...
//        getDialog().getWindow().addFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL);
    ...
    private void initView(View view) {
        ...
        //关闭按钮
        mIvClose = (Button) view.findViewById(R.id.btn_cancel);
        //关闭按钮+线 的整个布局
