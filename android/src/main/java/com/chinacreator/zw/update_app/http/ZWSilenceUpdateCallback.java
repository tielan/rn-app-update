...
public class ZWSilenceUpdateCallback extends ZWUpdateCallback {

    public ZWSilenceUpdateCallback(String downloadUrl, int versionCode) {
        super(downloadUrl, versionCode);
    }
