package com.chinacreator.zw.update_app.service;
...
//        }
    ...
    private void startDownload(UpdateAppBean updateApp, final DownloadCallback callback) {
        ...
        headers.put("x-api-key",updateApp.getApiKey());
        updateApp.getHttpManager().download(apkUrl, target, appName,headers, new FileDownloadCallBack(callback));
    }
